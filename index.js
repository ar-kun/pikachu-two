...
function displayResults(data) {
 ...
 <div class="flex flex-col items-center pb-10">
  <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="${pokemon['sprites']['front_default']}" alt="Bonnie image" />
  <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">${pokemon['name']}</h5>
  <span class="text-sm text-gray-500 dark:text-gray-400">${pokemon['types'][0]['type']['name']}</span>
